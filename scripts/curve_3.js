window.curve = (function() {
    ...
    function curvDraw(pathId, startLon, startLat, endLon, endLat, minAltitude, maxAltitude) {
        ...
        addModelFollowingPath(ellipsePoints);
    }
    ...
    function addModelFollowingPath(ellipsePoints) {
        ...
        const customclock = new Cesium.Clock({
        ...
        ellipsePoints.forEach((position, i) => {
            const timeOffset = i *(totalSeconds /  (ellipsePoints.length - 1));
            //const time = Cesium.JulianDate.addSeconds(customclock.startTime, i * (totalSeconds / ellipsePoints.length), new Cesium.JulianDate());
            const time = Cesium.JulianDate.addSeconds(customclock.startTime, timeOffset, new Cesium.JulianDate());
        ...
        viewer.entities.add({
            position: new Cesium.CallbackProperty(() => {
                return positionProperty.getValue(customclock.currentTime);
            }),
        ...
        // viewer.clock.stopTime = Cesium.JulianDate.fromIso8601("2025-01-01T00:00:00Z");
